...
#define MBED_CONF_SD_SPI_CLK                                                  P8_3                                                                                             // set by library:sd[RZ_A1H]
#define MBED_CONF_SD_SPI_CS                                                   P8_4                                                                                             // set by library:sd[RZ_A1H]
#define MBED_CONF_SD_SPI_MISO                                                 P8_6                                                                                             // set by library:sd[RZ_A1H]
#define MBED_CONF_SD_SPI_MOSI                                                 P8_5                                                                                             // set by library:sd[RZ_A1H]
...
#define MBED_CONF_APP_CAMERA_TYPE CAMERA_OV7725          // default: CAMERA_MT9V111
#define MBED_CONF_APP_LCD                           1    // set by application
#define MBED_CONF_APP_LCD_TYPE GR_PEACH_4_3INCH_SHIELD   // default: GR_PEACH_4_3INCH_SHIELD
...
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         8192
