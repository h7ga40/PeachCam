...
typedef enum {
  ...
  osPriorityLow1          =  3,         ///< Priority: low + 1
  osPriorityBelowNormal   =  4,         ///< Priority: below normal
  osPriorityBelowNormal1  =  5,         ///< Priority: below normal + 1
  osPriorityNormal        =  6,         ///< Priority: normal
  osPriorityNormal1       =  7,         ///< Priority: normal + 1
  osPriorityAboveNormal   =  8,         ///< Priority: above normal
  osPriorityAboveNormal1  =  9,         ///< Priority: above normal + 1
  osPriorityHigh          = 10,         ///< Priority: high
  osPriorityHigh1         = 11,         ///< Priority: high + 1
