...
get_thrown_object_ptr(_Unwind_Exception* unwind_exception)
{
    ...
    if (*(uint64_t *)&unwind_exception->exception_class == kOurDependentExceptionClass)
                     ...
                     _Unwind_Context* context)
{
    ...
    bool native_exception = (*(uint64_t *)&unwind_exception->exception_class & get_vendor_and_language) ==
                            (kOurExceptionClass & get_vendor_and_language);
...
__cxa_call_unexpected(void* arg)
{
    ...
    bool native_old_exception =
        (*(uint64_t *)&unwind_exception->exception_class & get_vendor_and_language) ==
        (kOurExceptionClass                & get_vendor_and_language);
    ...
    catch (...)
    {
        ...
        if (native_old_exception)
        {
            ...
            bool native_new_exception =
                (*(uint64_t *)&new_exception_header->unwindHeader.exception_class & get_vendor_and_language) ==
                                                (kOurExceptionClass & get_vendor_and_language);
            void* adjustedPtr;
            if (native_new_exception && (new_exception_header != old_exception_header))
            {
                ...
                adjustedPtr =
                		*(uint64_t *)&new_exception_header->unwindHeader.exception_class == kOurDependentExceptionClass ?
