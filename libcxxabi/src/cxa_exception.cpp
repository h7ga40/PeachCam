...
static void setExceptionClass(_Unwind_Exception* unwind_exception) {
	*(uint64_t *)&unwind_exception->exception_class = kOurExceptionClass;
}

static void setDependentExceptionClass(_Unwind_Exception* unwind_exception) {
	*(uint64_t *)&unwind_exception->exception_class = kOurDependentExceptionClass;
}

//  Is it one of ours?
static bool isOurExceptionClass(const _Unwind_Exception* unwind_exception) {
    return (*(uint64_t *)&unwind_exception->exception_class & get_vendor_and_language) ==
           (kOurExceptionClass                & get_vendor_and_language);
}

static bool isDependentException(_Unwind_Exception* unwind_exception) {
    return (*(uint64_t *)&unwind_exception->exception_class & 0xFF) == 0x01;
}
