...
void lcd_drawFastHLine(LCD_Handler_t *lcd, int16_t x, int16_t y,
...
void lcd_drawFastHLine_(LCD_Handler_t *lcd, int16_t x, int16_t y,
	int16_t w, uint16_t color);
void lcd_fillRect(LCD_Handler_t *lcd, int16_t x, int16_t y, int16_t w, int16_t h,
	uint16_t color);
