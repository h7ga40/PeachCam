 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nMruby_tInt16Pointer.c 1484 2018-03-30 12:24:59Z coas-nagasima $
 */
...
#include "nMruby_tInt16Pointer_tecsgen.h"
...
CHECK_AND_GET_POINTER( Int16, int16_t )
 ...
 * global_name:  nMruby_tInt16Pointer_eInitialize_initializeBridge
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
