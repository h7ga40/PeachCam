 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: nMruby_tULongPointer.c 1484 2018-03-30 12:24:59Z coas-nagasima $
 */
 ...
 * global_name:  nMruby_tULongPointer_eInitialize_initializeBridge
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eInitialize_initializeBridge(mrb_state* mrb, struct RClass * TECS)
{
	...
	(void)tecs_init_ULongPointer( mrb, TECS );
}
