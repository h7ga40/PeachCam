 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tDefinedTypeInfo.c 2665 2017-07-24 08:59:28Z okuma-top $
 */
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getName
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getNameLength
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint16_t
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getSize
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
eTypeInfo_getSize(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
  return cTypeInfo_getSize();
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getKind
 * name:         eTypeInfo_getKind
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getKind
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int8_t
eTypeInfo_getKind(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
  return TECSTypeKind_DefinedType;
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getNType
 * name:         eTypeInfo_getNType
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getNType
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getTypeInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
eTypeInfo_getTypeInfo(CELLIDX idx, Descriptor( nTECSInfo_sTypeInfo )* desc)
{
	...
	/* Put statements here #_TEFB_# */
  /*
   * ith == 0 is valid, others are invalid.
   * but this function always returns valid value
   */
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tDefinedTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
