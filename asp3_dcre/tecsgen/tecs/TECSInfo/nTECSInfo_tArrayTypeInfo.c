 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tArrayTypeInfo.c 2666 2017-07-25 07:58:47Z okuma-top $
 */
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getName
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getNameLength
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint16_t
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getSize
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getKind
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int8_t
eTypeInfo_getKind(CELLIDX idx)
{
	...
	/* ここに処理本体を記述します #_TEFB_# */
	return TECSTypeKind_ArrayType;
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getNType
 * name:         eTypeInfo_getNType
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getNType
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
eTypeInfo_getNType(CELLIDX idx)
{
	...
	/* ここに処理本体を記述します #_TEFB_# */
	return ATTR_size / cTypeInfo_getSize();  /* 配列要素数 = サイズ / 要素サイズ */
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getTypeInfo
 * name:         eTypeInfo_getTypeInfo
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getTypeInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tArrayTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
