 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tDescriptorTypeInfo.c 2665 2017-07-24 08:59:28Z okuma-top $
 */
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getName
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getNameLength
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint16_t
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getSize
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getKind
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
int8_t
eTypeInfo_getKind(CELLIDX idx)
{
	...
	/* ここに処理本体を記述します #_TEFB_# */
  return TECSTypeKind_DescriptorType;
}

/* #[<ENTRY_FUNC>]# eTypeInfo_getNType
 * name:         eTypeInfo_getNType
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getNType
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getTypeInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tDescriptorTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
