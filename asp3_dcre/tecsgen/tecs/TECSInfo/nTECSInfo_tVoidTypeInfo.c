 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tVoidTypeInfo.c 2665 2017-07-24 08:59:28Z okuma-top $
 */
 ...
 * global_name:  nTECSInfo_tVoidTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tVoidTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
