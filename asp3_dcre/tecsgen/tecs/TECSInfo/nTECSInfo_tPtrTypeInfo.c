 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: nTECSInfo_tPtrTypeInfo.c 2665 2017-07-24 08:59:28Z okuma-top $
 */
 ...
 * global_name:  nTECSInfo_tPtrTypeInfo_eTypeInfo_getNMember
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
uint32_t
 ...
 * global_name:  nTECSInfo_tPtrTypeInfo_eTypeInfo_getMemberInfo
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
ER
