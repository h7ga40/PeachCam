...
# @@comment[ :MCPP_comment ] = "/* セル CB プロトタイプ宣言 %s */\n"
@@comment[ :MCPP_comment ] = "/* cell CB prototype declaration %s */\n"

# @@comment[ :MCPB_comment ] = "/* セル CB プロトタイプ宣言 %s */\n"
@@comment[ :MCPB_comment ] = "/* cell CB prototype declaration %s */\n"
end
