 ...
 *  の責任を負わない．
 * 
 *  $Id: mutex.h 1484 2018-03-30 12:24:59Z coas-nagasima $
 */
 ...
 *  ク解除した際の現在優先度変更処理を行う．
 */
extern void	mutex_drop_priority(TCB *p_tcb, MTXCB *p_mtxcb);
 ...
 *  クさせる．
 */
extern void	mutex_acquire(TCB *p_tcb, MTXCB *p_mtxcb);
 ...
 *  にミューテックスをロックさせる．
 */
extern void	mutex_release(MTXCB *p_mtxcb);
 ...
 */
extern void	mutex_release_all(TCB *p_tcb);
