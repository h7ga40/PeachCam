 ...
 * 
 *  @(#) $Id: tcp_echo_srv1.h 1484 2018-03-30 12:24:59Z coas-nagasima $
 */

#ifdef USE_TCP_ECHO_SRV1

#ifndef _TCP_ECHO_SRV1_H_
#define _TCP_ECHO_SRV1_H_
...
#ifndef NUM_TCP_ECHO_SRV_TASKS
#define NUM_TCP_ECHO_SRV_TASKS		1
#endif

/* IPv4 用の TCP エコーサーバタスクは 1個に制限する。*/

#ifdef  NUM_TCP4_ECHO_SRV_TASKS
#undef  NUM_TCP4_ECHO_SRV_TASKS
#endif
#define NUM_TCP4_ECHO_SRV_TASKS		1
...
extern ER wakeup_tcp_echo_srv (char apip);

#endif	/* of #ifndef _TCP_ECHO_SRV1_H_ */
