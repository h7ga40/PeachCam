 ...
 * 
 *  @(#) $Id: tcp_discard_srv.h 1484 2018-03-30 12:24:59Z coas-nagasima $
 */

#ifndef _TCP_DISCARD_SRV_H_
#define _TCP_DISCARD_SRV_H_
...
#define TCP_DISCARD_SRV_RWBUF_SIZE	(1024)

#elif defined(SUPPORT_INET4)

#define TCP_DISCARD_SRV_RWBUF_SIZE	(512)

#endif	/* of #if defined(SUPPORT_INET6) */

#else	/* of #if defined(USE_TCP_MSS_SEG) || defined(USE_IPV6_MMTU) */

#define TCP_DISCARD_SRV_RWBUF_SIZE	(2048)
