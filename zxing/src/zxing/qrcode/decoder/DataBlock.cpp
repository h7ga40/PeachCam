...
int DataBlock::getDataBlocks(ArrayRef<char> rawCodewords, Version *version,
	ErrorCorrectionLevel &ecLevel, std::vector<Ref<DataBlock>> &result)
{
	...
	result = std::vector<Ref<DataBlock> >(totalBlocks);
