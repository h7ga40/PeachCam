...
int MultiFinderPatternFinder::findMulti(DecodeHints const &hints, vector<Ref<FinderPatternInfo>> &result)
{
	...
	int ret;
	vector<vector<Ref<FinderPattern>>> patternInfo;
...
int MultiFinderPatternFinder::selectBestPatterns(vector<vector<Ref<FinderPattern>>> &results)
{
