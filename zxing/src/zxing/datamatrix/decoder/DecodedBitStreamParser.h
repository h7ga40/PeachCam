...
private:
	 ...
	 */
	int decodeC40Segment(Ref<BitSource> bits, std::ostringstream &result);
	/**
	 * See ISO 16022:2006, 5.2.6 and Annex C, Table C.2
	 */
	int decodeTextSegment(Ref<BitSource> bits, std::ostringstream &result);
	/**
	 * See ISO 16022:2006, 5.2.7
	 */
	int decodeAnsiX12Segment(Ref<BitSource> bits, std::ostringstream &result);
	/**
	 ...
	 */
	int decodeBase256Segment(Ref<BitSource> bits, std::ostringstream &result, std::vector<char> byteSegments);
...
public:
	...
	int decode(ArrayRef<char> bytes, Ref<DecoderResult> &result);
};
