...
public:
    ...
    */
    ...
    bool socket_setopt(int id, const char *optname, int optval);
    bool socket_setopt(int id, const char *optname, const char *optval);

    bool socket_getopt(int id, const char *optname, int *optval);
