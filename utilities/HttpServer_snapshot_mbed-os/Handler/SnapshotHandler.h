...
{
public:
    SnapshotHandler(const char* rootPath, const char* path, TCPSocket* pTCPSocket);
    ...
    static void attach_req_send_end(void(*fptr)(const char* rootPath, const char* path, const char * p_data)) {
        callback_func_send_end = fptr;
    }
...
private:
    ...
    static void (*callback_func_send_end)(const char* rootPath, const char* path, const char * p_data);
